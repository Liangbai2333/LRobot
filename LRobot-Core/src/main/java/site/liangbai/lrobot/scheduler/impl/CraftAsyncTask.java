...
import site.liangbai.lrobot.scheduler.LWorker;
...
class CraftAsyncTask extends CraftTask {
    ...
    private final LinkedList<LWorker> workers = new LinkedList<>();
    ...
    public void run() {
        ...
        try {
            ...
            thrown = t;
            PluginManager.logger.error(String.format(
            ...
            synchronized(workers) {
                try {
                    final Iterator<LWorker> workers = this.workers.iterator();
